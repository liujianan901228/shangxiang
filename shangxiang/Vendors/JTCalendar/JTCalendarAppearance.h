...
@property (strong, nonatomic) UIColor *daySmallTextColorOtherMonth;
@property (strong, nonatomic) UIColor *daySmallTextColor;

@property (strong, nonatomic) UIFont *dayTextFont;
@property (strong, nonatomic) UIFont *daySmallTextFont;
