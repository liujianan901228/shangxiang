...
-(void)InitializeValue
{
    ...
    NSArray *beginArray = [[NSArray alloc] initWithObjects:
                           @"1960-01-28",@"1965-02-02",@"1970-02-06",@"1975-02-11",@"1980-02-16",
                           @"1985-02-20",@"1990-01-27",@"1995-01-31",@"2000-02-05",@"2005-02-09",
                           @"2010-02-14",@"2015-02-19",@"2020-01-25",@"2025-01-29",@"2030-02-02",
                           nil];
    
    int num = 0;
    NSInteger tempYear = thisdate.year;
    if (tempYear < 1959) {
        return;
    }
    else
    {
        num = (int)(tempYear-1960)/5-1;
        if (num < 0) {
            num = 0;
        }
        
    }
    NSString *start = beginArray[num];
    ...
    //计算农历年
    for (lunarYear = startDate.year; lunarYear < 2100 && sumdays > 0; lunarYear++)
    {
